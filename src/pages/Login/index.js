      ...
      <div className="flex h-screen justify-center items-center">
        <div className="w-80 rounded-lg overflow-hidden shadow-2xl m-4 bg-gray-100">
          ...
          <div className="flex items-center px-6 py-4">
            {isLoading ? (
              <button
                className="inline-flex items-center bg-blue-500 hover:bg-blue-700 transition duration-150 ease-in-out text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-not-allowed"
                type="submit"
              ...
              >
                Login
                <svg
                  className="w-5 h-5 -mr-1 ml-3 text-white animate-spin"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                >

...
export default function Sidebar({ toggleSidebar, isShowSidebar }) {
  return (
    <div
      className={`fixed px-8 pt-4 transition top-0 bg-white right-0 h-screen lg:hidden ${
